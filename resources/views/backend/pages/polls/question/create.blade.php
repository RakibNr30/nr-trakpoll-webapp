            ...
            <form action="{{ url('admin/polls/'.$poll->id.'/question') }}" method="POST">
                @csrf
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="question" aria-describedby="questionHelp" name="question[question]" value="{{ old('question.question') }}" placeholder="Enter Your Question">
